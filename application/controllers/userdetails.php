...
//         }
        ...
        if($user_details)
		{
            // add cost details in user_cost_table start 26/09/2022
            $cost_details = array(
                'user_id'=> $user_details['emp_id'],
                'hourly_rate'=>$hourly_rate,
            ...
            $addUserCost = $this->userdetails_model->insertUserCost($cost_details);
            // add cost details in user_cost_table end 26/09/2022
            ...
            //echo $Sendto.$MailSubject.$MailTemplateContents;
