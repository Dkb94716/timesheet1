 ...
 * @author sochoa
 */
class OKMWebservice20 implements OKMWebservices {
    ...
    public function setLanguage($docId, $lang) {
        return $this->docImpl->setLanguage($docId, $lang);
    }
    ...
    public function setTitle($docId, $title) {
        return $this->docImpl->setTitle($docId, $title);
    }
    ...
    public function setDocumentNodeClass($docId, $ncId) {
        return $this->docImpl->setDocumentNodeClass($docId, $ncId);
    }
    ...
    public Function getDetectedLanguages() {
        return $this->docImpl->getDetectedLanguages();
    }
