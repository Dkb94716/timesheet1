...
//        echo '</div>';
    ...
    public function printQueryParams(QueryParams $queryParams) {
        ...
        echo '<p><strong>Folder</strong>:' . $queryParams->getFolder() . '</p>';
        echo '<p><strong>FolderRecursive</strong>:' . $queryParams->isFolderRecursive() . '</p>';
        echo '<p><strong>QueryName</strong>:' . $queryParams->getQueryName() . '</p>';
        echo '<p><strong>User</strong>:' . $queryParams->getUser() . '</p>';
        echo '<p><strong>Notes</strong>:' . $queryParams->getNotes() . '</p>';
