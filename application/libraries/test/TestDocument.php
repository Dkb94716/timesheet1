...
class TestDocument {
    ...
    const TEST_DOC_UUID = 'c4ba330b-2a2e-4530-9034-c9d006d220f4';
    ...
    public function test() {
        ...
        try {
            ...
            $document = $this->ws->getDocumentProperties(self::TEST_DOC_PATH);
            $this->printDocument($document, 'getDocumentProperties');
        } catch (PathNotFoundException $e) {
            echo '<p>'.$e->getMessage() . '</p>';
            echo '<p><strong>PathNotFoundException:</strong>' . $e->getTraceAsString().'</p>';
        }
...
//        $this->ws->setProperties($document);
        //setLanguage
        //echo '<h2>setLanguage</h2>';
        //$this->ws->setLanguage(self::TEST_DOC_TEXT, 'es');
        //$this->printDocument($this->ws->getDocumentProperties(self::TEST_DOC_TEXT), 'setLanguage');
        //setTitle
        //echo '<h2>setTitle</h2>';
        //$this->ws->setTitle(self::TEST_DOC_TEXT, 'FileText');
        //$this->printDocument($this->ws->getDocumentProperties(self::TEST_DOC_TEXT), 'setTitle');   
        //setNodeClass
        //echo '<h2>setNodeClass</h2>';
        //$this->ws->setDocumentNodeClass(self::TEST_DOC_TEXT, 1);
        //$this->printDocument($this->ws->getDocumentProperties(self::TEST_DOC_TEXT), 'setNodeClass');
        //checkout
        //echo '<h2>checkout</h2>';
...
//        $languages = $this->ws->getDetectedLanguages();
//        echo '<h2>getDectectedLanguages</h2>';
