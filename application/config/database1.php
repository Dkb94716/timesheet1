...
$db['default']['username'] = 'timesheet_usr';
$db['default']['password'] = 'K7nH?Qj!UjKV';
$db['default']['database'] = 'timesheet_db';
...
$db['database_two']['username'] = 'timesheet_usr';
$db['database_two']['password'] = 'K7nH?Qj!UjKV';
$db['database_two']['database'] = 'timesheet_db';
