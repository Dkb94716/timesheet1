      ...
      <table class="dynamicTable tableTools table table-striped overflow-x">
        <thead>
          <tr style="background-color:#c72a25; color:#FFF;">
            ...
            <th width="55" class="thead-th-padg">Actual Hours</th>
            ...
            <td><span><?php echo $task->task_name; ?> </span></td>
             <td><span><?php echo $task->team_name; ?> </span></td>
              <td><span><?php echo $task->expense; ?> </span></td>
               ...
               <td><span><?php echo $task->actual_hours;  ?></span></td>
            <td align="right">
          ...
          <div class="innerLR">
            <form class="form-horizontal" role="form" id="editForm">
              <div class="form-group">
                <label class="col-sm-4 control-label" style="text-align:left;margin-bottom:10px">Task Name</label>
                <div class="col-sm-7">
                   <input type="hidden" class="form-control" name="edit_task_project_id" id="edit_task_project_id" maxlength="200"  placeholder="Task Name">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label"style="text-align: left;"> Actual Hours</label>
                <div class="col-sm-7"> 
                  <input type="text" class="form-control" name="edit_actual_hrs" id="edit_actual_hrs" maxlength="200"  placeholder="0.00"> 
                </div>
              </div>
        ...
        $('#editForm').bootstrapValidator({
            ...
            fields: {
             ...
             $('.btn-success').attr("disabled", "disabled");
                    ...
                    var project_id = $('#edit_task_project_id').val();
                    ...
                    var actual_hours = $('#edit_actual_hrs').val();
    ...
    function edit_task(id) {
        ...
        request.done(function (msg) {
            ...
            $.each(msg, function (i, item) {
                ...
                $('#edit_task_project_id').val(item.project_id);
                ...
                $('#edit_actual_hrs').val(item.actual_hours);
            });
        });
