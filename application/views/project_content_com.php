      ...
      <table class="dynamicTable tableTools table table-striped overflow-x">
        <thead>
          <tr style="background-color:#c72a25; color:#FFF;">
            ...
            <th width="55" class="thead-th-padg">Manager Name</th>
            <th width="55" class="thead-th-padg">Project Status</th>
            <th width="70" class="thead-th-padg">Completed Date</th>
        ...
        <tbody>
          ...
          <tr class="gradeX">
            ...
            <td><span><?php if($project->completed_date !="") { $date=date_create($project->completed_date); echo date_format($date,"d F Y");} ?> </span></td>
...
<script>
            ...
            fields: {
             ...
             $('.btn-success').attr("disabled", "disabled");
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        data: {project_name: project_name,client_name:client_name,currency_code:currency_code,manager_name:manager_name},
                        beforeSend: function ()
                        {
                            $("#addloader").show();
                        },
            ...
            fields: {
                ...
                .on('success.form.bv', function (e) {
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        data: {project_id: project_id, project_name: project_name,client_name: client_name, currency_code: currency_code,project_status:project_status,manager_name:manager_name},
                        beforeSend: function ()
                        {
                            $("#editloader").show();
    ...
    function edit_project(id) {
        ...
        var request = $.ajax({
            url: CURRENT_URL + '/project/edit_project_com',
            type: "POST",
            data: {project_id: id},
            dataType: "json"
        });
