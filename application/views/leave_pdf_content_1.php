<?php //echo "<pre>"; print_r($balance_leave_detail);?>
                    ...
                    <div class="col-md-12 pull-right" id="balance_leave" style="text-align:end;">
                        ...
                        if (!empty($balance_leave_detail)) {
                            ...
                            foreach ($balance_leave_detail as $balance_leave) {
                                ...
                                ?>
                                <?php echo $balance_leave->leave_type; ?>: <?php echo $balance_leave->balance_leave; ?> <?php echo $separator; ?>
                                <?php
                            }
                        }
                        ?>
