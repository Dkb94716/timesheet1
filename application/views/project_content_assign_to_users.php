...
<div class="col-lg-12" style="margin-top:20px;">
  ...
  <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 pull-right">
      ...
      <a href="#modal-add" data-toggle="modal" class="btn-sm btn-warning pull-right" style="margin-left:8px;">Assign Project To User</a> </div>
       <?php } ?>
</div>
      ...
      <table class="dynamicTable tableTools table table-striped overflow-x">
        <thead>
          <tr style="background-color:#c72a25; color:#FFF;">
            ...
            <th width="44" class="thead-th-padg">Project Status</th>


            <th width="55" class="thead-th-padg">Client Name</th>
            <th width="55" class="thead-th-padg">User Name</th>
            
            <th width="148" class="thead-th-padg" align="right" style="padding-right: 50px !important;text-align: right;">
                <?php if (($userPrivileges->administration_control->assign_projects->Edit == 1) || ($userPrivileges->administration_control->assign_projects->Delete == 1)) { ?>
                    Actions
            <?php } ?>
            </th>
          </tr>
        ...
        <tbody>
          <?php
          if (!empty($assigned_project_list)) {
          // echo "<pre>"; print_r($assigned_project_list); die;

            foreach ($assigned_project_list as $project)
                {
          ...
          <tr class="gradeX">
            ...
            <td align="right">
                 <?php if ($userPrivileges->administration_control->assign_projects->Edit == 1) { ?>
                ...
                <?php } 
                  if ($userPrivileges->administration_control->assign_projects->Delete == 1) { ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Assign Project To User</h3>
      </div>
      <!-- // Modal heading END --> 
          ...
          <div class="innerLR">
            <form class="form-horizontal" role="form" id="addForm">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label"style="text-align: left;">Client Name</label>
                <div class="col-sm-7"> 
                  <select  class="form-control" name="client_name" id="client_name" onchange="get_project(this.value,'project_name')">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label" style="text-align:left;margin-bottom:10px">User Name</label>
                <div class="col-sm-7">
                   <select  class="form-control" name="user_name" id="user_name" >
                    ...
                    ?>
                   <option value="<?php echo $user_data->empName;?>"><?php echo $user_data->empName;?></option>
                   <?php  }?>
                   </select>
                </div>
              </div>
...
<div class="modal fade"  id="modal-edit">
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3 class="modal-title">Edit Assign Project To User</h3>
      </div>
      <!-- // Modal heading END --> 
          ...
          <div class="innerLR">
            <form class="form-horizontal" role="form" id="editForm">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <select  class="form-control" name="edit_client_name" id="edit_client_name" onchange="get_project(this.value,'edit_project_name')"> 
                   <option value="">Select</option>
                   <?php foreach($clent_details as $client){ ?>
                    <option value="<?php echo $client->client_name; ?>"><?php echo $client->client_name; ?></option>
                   <?php } ?>
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label" style="text-align:left;margin-bottom:10px">User Name</label>
                <div class="col-sm-7">
                   <select  class="form-control" name="edit_user_name" id="edit_user_name" >
                    <option value="">Select</option>
                    <?php
                    foreach($users_list as $user_data){
                    ?>
...
<script>
        ...
        $('#addForm').bootstrapValidator({
            ...
            fields: {
              client_name: {
                    validators: {
                        notEmpty: {
                            message: 'Claint name is required.'
                        }
                    }
                },
                project_name: {
                ...
                .on('success.form.bv', function (e) {
                    ...
                    // alert(user_name); return false;
                  
                    $.ajax({
                        async: true,
                        type: "POST",
                        url: CURRENT_URL + '/project/add_project_assign_to_user',
                        dataType: "json",
                        data: {project_name: project_name,client_name:client_name,user_name:user_name},
                        beforeSend: function ()
                        {
                            $("#addloader").show();
                        },
              ...
              edit_client_name: {
                ...
                .on('success.form.bv', function (e) {
                    ...
                    $.ajax({
                        async: true,
                        type: "POST",
                        url: CURRENT_URL + '/project/submit_edit_project_assigned',
                        dataType: "json",
                        data: {project_id: project_id, project_name: project_name,client_name: client_name, user_name: user_name,type:1},
                        beforeSend: function ()
                        {
                            $("#editloader").show();
                        },
    ...
    function edit_project(id) {
        ...
        var request = $.ajax({
            url: CURRENT_URL + '/project/edit_project_assigned',
            type: "POST",
            data: {project_id: id},
            dataType: "json"
        });
        request.done(function (msg) {
            $.each(msg, function (i, item) {
               ...
               $('#edit_user_name').val(item.user_name);
    ...
    function delete_project(id) {
        bootbox.confirm("Are you sure you want to remove project from this user?", function (result) {
            if (result == true) {
                var request = $.ajax({
                    url: CURRENT_URL + '/project/delete_project_assigned',
                    type: "POST",
                    data: {project_id: id},
                    dataType: "json"
                });
    ...
    function get_project(client_name, id){
      var request = $.ajax({
            url: CURRENT_URL + '/project/get_project_assign',
            type: "POST",
