...
<div id="rootwizard" class="wizard">
    ...
    <div class="widget">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                    ...
                                    <div class="col-sm-12" style="padding-left:0px;">
                                        <div class="col-sm-5" style="padding-left:0px;padding-right:8px;">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control height_25 plahole_font"  type="text" id="username1" name="username1" placeholder="First Name">
                                        ...
                                        <div class="col-sm-5" style="padding-left: 20px; padding-right: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control height_25 plahole_font"  type="text" id="surname" name="surname" placeholder="Last Name">
                                            </div>	
                                        </div>
                                    </div>        
                                    <div class="col-sm-5" style="padding-left:0px;">
                                        <div class="form-group">
                                            ...
                                            <label class="control-label inputtext_formating" for="fullname">Other Name :</label>
                                            <input class="form-control height_25 plahole_font"  type="text" id="othername" name="othername" placeholder="Other Name">
                                        </div>	
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    <div class="col-sm-5" style="padding-left:0px;">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control height_25 plahole_font" type="text" id="employeeId" name="employeeId" placeholder="Employee ID" onchange="check_emp_id(this.value)">
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <!-- Adding column for Hourly rate  -->
                                            <label class="control-label inputtext_formating" for="PlaceOfBirth">Hourly Rate :</label>
                                            <input class="form-control height_25 plahole_font" type="number" id="hourly_rate" name="hourly_rate" placeholder="Hourly Rate" step="0.01">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12" style="padding-left:0px;">
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    <div class="col-sm-5" style="padding-left:0px;">
                                        <div class="form-group">
                                            <label class="control-label inputtext_formating" for="password">Team <span style="color:#a94442"></span> :</label>
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    <div class="col-sm-5" style="padding-left:0px;">
                                        <div class="form-group">
                                            <label class="control-label inputtext_formating" for="password_confirmation">Department <span style="color:#a94442"></span> :</label>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <label class="control-label inputtext_formating" for="password">Country <span style="color:#a94442"></span> :</label>
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    <div class="col-sm-5" style="padding-left:0px;">
                                        <div class="form-group">
                                           ...
                                           <!-- <input class="form-control height_25 plahole_font" type="Email" name="emailId" id="emailId" placeholder="Email ID" onchange="check_email_id(this.value)"/>
                                                --> 
                                           <input class="form-control height_25 plahole_font" type="Email" name="emailId" id="emailId" placeholder="Email ID" />
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control height_25 plahole_font" type="text" id="homeTel" name="homeTel" placeholder="Home Telephone No.">
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control height_25 plahole_font" type="text" id="mobileNo" name="mobileNo" placeholder="Mobile No." >
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    <div class="col-sm-5" style="padding-left:0px;">
                                        <div class="form-group">
                                            <label for="email" class="control-label inputtext_formating">Nationality <span style="color:#a94442"></span> :</label>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <select id="accesslevel" name="accesslevel" class="form-control height_24 plahole_font" >
                                                <option value="">-- select one --</option>
                                ...
                                <div class="col-sm-12" style="padding-left:0px;">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control height_25 plahole_font" id="address" name="address" placeholder="Address" style="resize:none;height: 100px;"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12" style="padding-left:0px;">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control height_24 plahole_font" id="status" name="status">
                                                ...
                                                <option value="Occupation permit">Occupation permit</option>
                                    ...
                                    <div class="col-sm-5" style="padding-left:0px;">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date datepicker2">
                                                <input  class="form-control height_25 plahole_font" type="text" value="" id="dtLeft" name="dtLeft" placeholder="Date Left" style="background-color : #fff;"/>
                                                <span class="input-group-addon"><i class="fa fa-th"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-5" style="padding-left:0px;">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="apply_leave" id="apply_leave" value="1" onclick="$(this).attr('value', this.checked ? 1 : 0)" style="float:left;">
                            ...
                            <div class="col-sm-2 col-xs-12" id="dvPreview" >
                                <a href="#"><img src="<?php echo base_url(); ?>assets/images/people/80/22.png" class="pull-right thumbnail imgupolad" id="imgupload" alt="Profile" style="margin-top:23px; width:110px; height:110px;"></a>
                            </div>
                            ...
                            <i class="form-control-feedback" style="display: none;" data-bv-icon-for="user_image"></i>
                        ...
                        <div class="col-sm-12" style="padding-left:0px; margin-top:40px;">
                            ...
                            <div class="col-sm-5" style="padding-left:0px;">
                                ...
                                <div class="col-sm-12" style="padding-left:0px; padding-right:2px;">
                                    <div class="form-group">
                                        <label for="name" class="control-label inputtext_formating">Full Name :</label>
                    ...
                    <div class="tab-pane" id="tab3">
                        ...
                        <div class="col-sm-12" style="padding-left:0px;">
                            ...
                            <div class="col-sm-5" style="padding-left:0px;">
                                <div class="form-group" class="control-label inputtext_formating">
                                    <label for="certificates_memberships" class="control-label inputtext_formating">Certificates/Memberships :</label>
                            ...
                            <div id="addinput">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control height_25 plahole_font" name="j_special_remarks[]" placeholder="Special Remarks"  style="resize:none;height: 100px;"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-5" style="padding-left:0px; margin-top:-75px;">
                                    <div class="form-group">
                            ...
                            <div id="addinput_3">
                                ...
                                <div class="col-sm-5" style="padding-left:0px;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control hiddenpension_filed"  type="text" id="i_pension_plan_text" name="i_pension_plan[]" placeholder="Pension Plan" style="float:left;">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-5 hiddenpension_filed">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date datepicker2">
                                            <input  class="form-control height_25 plahole_font" type="text" id="i_pension_plan_date" name="i_pension_date_joined[]" name="Date Joined" placeholder="Date Joined"  style="background-color : #fff;"/>
                                            <span class="input-group-addon"><i class="fa fa-th"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="addinput_4">
                                ...
                                <div class="col-sm-5" style="padding-left:0px;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control hiddenmedical_filed"  type="text" id="i_medical_plan_text" name="i_medical_plan[]" placeholder="Medical Plan" style="float:left;">
                                    </div>
                                </div>
                                <div class="col-sm-5 hiddenmedical_filed">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date datepicker2">
                                            <input  class="form-control height_25 plahole_font" type="text" id="i_medical_plan_date" name="i_medical_date_Joined[]" placeholder="Date Joined"  style="background-color : #fff;"/>
                                            <span class="input-group-addon"><i class="fa fa-th"></i></span>
                                        </div>
                                    </div>
                                </div>
        ...
        <ul class="pagination" style="padding-bottom: 20px;clear: both;padding-left: 20px;">
...
<!--            <button class=" next primaryno-ajaxify btn btn-success" >Next</button>-->
  ...
  if (code  == 13) {               
    ...
    <script language="javascript" type="text/javascript">
        ...
        function check_email_id(emailId){
