...
elseif ($controller == "upload_user_hourly_rate") {
    $upload_user_hourly_rate = "active";
} 
elseif ($controller == "project_expense") {
    $project_expense = "active";
} 
...
$arr_left_upload_task = $userPrivileges->administration_control->upload_task;
$arr_left_project_wise_report = $userPrivileges->administration_control->project_wise_report;
$arr_left_project_expense = $userPrivileges->administration_control->project_expense;
    ...
    <div id="sidebar-fusion-wrapper">
        ...
        <?php //if ($userPrimeryId != 1) { ?>
            <ul class="menu list-unstyled" style="top:80px;">
                ...
                <?php } ?>
                <?php if ( $arr_left_upload_task->Add == 1 ) { ?>   
                ...
                <?php if ($arr_left_report->View == 1 || $arr_left_report->PrintReport == 1 || $arr_left_report->ExportExcel == 1) { ?>
                    <li class="<?php echo $pending_report_list; ?>">
                        <a href="<?php echo base_url() ?>report/timesheet_report_pending" class="no-ajaxify">
                            <i class="fa fa-pie-chart icon-graph-up-1"></i>
                            <span>Pending-Report</span>
                        </a>
                    </li>
                <?php } ?>
                
                <?php if ($arr_left_project_wise_report->View == 1 || $arr_left_project_wise_report->PrintReport == 1) { ?>   
                    <li class="<?php echo $project_wise_report ?>">
                        <a href="<?php echo base_url(); ?>report/project_wise_report" class="no-ajaxify">
                            <i class="fa fa-line-chart icon-graph-up-1"></i>
                            <span>Project Wise Report</span>
                        </a>
                    </li>
                <?php } ?>     

                <?php if ($arr_left_project_expense->View == 1 || $arr_left_project_expense->PrintReport == 1) { ?>   
                    <li class="<?php echo $project_expense ?>">
                        <a href="<?php echo base_url(); ?>report/project_expense" class="no-ajaxify">
                            <i class="fa fa-fw  icon-compose"></i>
                ...
                <?php } ?>
                <?php if ( $session_val['logged_in']['usrRoleld'] == 1 ) { ?>   
                    <li class="<?php echo $upload_user_hourly_rate ?>">
                        <a href="<?php echo base_url(); ?>timesheet/upload_user_hourly_rate" class="no-ajaxify">
                            <i class="fa fa-fw  icon-compose"></i>
                            <span>Upload Hourly Rate</span>
                        </a>
                    </li>
                <?php } ?>
            </ul>
