                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control height_25 plahole_font" type="number" id="hourly_rate" name="hourly_rate" step="0.01" placeholder="Hourly Rate" value="<?php echo $userdetail->hourly_rate; ?>">
                                        </div>
                                    </div>
                                </div>
                                    <div class="col-sm-12" style="padding-left:0px;">
