        ...
        <div class="innerAll">
          <div class="innerLR">
            <form class="form-horizontal" role="form" id="addForm">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label" style="text-align:left;margin-bottom:10px">Project Manager</label>
                <div class="col-sm-7">
        ...
        $('#addForm').bootstrapValidator({
          ...
          .on('success.form.bv', function (e) {
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        data: {project_name: project_name,client_name:client_name,currency_code:currency_code,manager_name:manager_name,start_date:start_date,dead_line_date:dead_line_date,est_cost:est_cost},
                        beforeSend: function ()
                        {
                            $("#addloader").show();
                        },
