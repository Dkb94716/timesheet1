...
<form class="form-horizontal" action="<?php echo base_url(); ?>/databaseinfo/submit_data" id="edit-director-individual-form"  role="form">
    <div class="col-md-6">
        ...
        <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
            ...
            <input name="director_name" type="text" value="<?php echo $detail[0]['director_name'];?>" class="form-control height_25 plahole_font" style="width: 100%;">
        </div>
        <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
                            <label class="client-detailes-sub_heading" style="width:100%;">Surname of director</label>                                
                            <input name="director_surname" type="text" value="<?php echo $detail[0]['director_surname'];?>" class="form-control height_25 plahole_font" style="width: 100%;">
       </div>  
    ...
    <div class="col-md-6">
        <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;border-bottom:1px solid #ddd;">
            ...
            <div class="radio pull-left" style="margin-right:30px;">
                <label class="radio-custom-none">
                    <input type="radio" class="radioYesBtn" name="has_passport" id="kyc_passport_show_div_edit" <?php echo $has_passport_yes; ?> value="1"> 
                    Yes
                </label> 
            </div>
            ...
            <div class="radio pull-left"> 
                <label class="radio-custom-none"> 
                    <input type="radio" class="radioNoBtn" name="has_passport" id="kyc_passport_hide_div_edit" <?php echo $has_passport_no; ?> value="0"> 
                    No
                </label> 
            </div>
        </div>
        ...
        <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
            ...
            <div class="radio pull-left" style="margin-right:30px;">
                <label class="radio-custom-none">
                    <input type="radio" class="radioYesBtn" name="has_cv" <?php echo $has_cv_yes; ?> id="director_cv_yes_edit" value="1"> 
                    Yes
                </label> 
            </div>
            ...
            <div class="radio pull-left"> 
                <label class="radio-custom-none"> 
                    <input type="radio" class="radioNoBtn" name="has_cv" <?php echo $has_cv_no; ?> id="director_cv_no_edit" value="0"> 
                    No
                </label> 
            </div>
        </div>
        ...
        <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
            ...
            <div class="radio pull-left" style="margin-right:30px;">
                <label class="radio-custom-none">
                    <input type="radio" class="radioYesBtn" name="has_bank_ref" id="bank_refrence_show_div_edit" <?php echo $has_bank_ref_yes; ?> value="1"> 
                    Yes
                </label> 
            </div>
            ...
            <div class="radio pull-left"> 
                <label class="radio-custom-none"> 
                    <input type="radio" class="radioNoBtn" name="has_bank_ref" id="bank_refrence_hide_div_edit" <?php echo $has_bank_ref_no; ?> value="0"> 
                    No
                </label> 
            </div>
        </div>
        ...
        <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
            ...
            <div class="radio pull-left" style="margin-right:30px;">
                <label class="radio-custom-none">
                    <input type="radio" class="radioYesBtn" name="is_address_proof" id="proof_of_address_show_div_edit" <?php echo $is_address_proof_yes; ?> value="1"> 
                    Yes
                </label> 
            </div>
            ...
            <div class="radio pull-left"> 
                <label class="radio-custom-none"> 
                    <input type="radio" class="radioNoBtn" name="is_address_proof" id="proof_of_address_hide_div_edit" <?php echo $is_address_proof_no; ?> value="0"> 
                    No
                </label> 
            </div> 
        </div>
        ...
        <div id="proof_of_address_show_hide_div_edit" style="display:<?php echo $proof_of_address_show_hide_div; ?>;">
            <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
                ...
                <textarea name="address_detail" style="width:100%;resize:vertical;"><?php echo $detail[0]['address_detail']; ?></textarea>
            </div>
            <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
        ...
        <div class="form-group td-area-form-marg" style="margin-bottom:10px !important;">
            ...
            <textarea id="other_detail_edit" name="other_detail" style="width:100%;resize:vertical;" ><?php echo $detail[0]['other_detail']; ?></textarea>
        </div>
    </div>	

    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <input type="hidden"  name="id" id="" style="width: 100%;" value="<?php echo $detail[0]['id']; ?>">
...
function CalculateDiff() {
    ...
    if($('#director_birth_date_edit').val()!="" && $.now()!=""){
 
var From_date = new Date($('#director_birth_date_edit').val());
...
//                            },
                            ...
                            .on('success.form.bv', function (e) {
                                e.preventDefault();
                                submit_director_individual_form('edit-director-individual-form', 'edit', '<?php echo $detail[0]['id']; ?>');
                            });
