            ...
            <table class="dynamicTable tableTools table table-striped overflow-x">
                <thead>
                    <tr style="background-color:#c72a25; color:#FFF;">
                        ...
                        <th class="thead-th-padg" id="action_h" align="right">
                ...
                <tbody>
                    ...
                    if (!empty($time_detail)) {
                        ...
                        <td><span class="center" style="width:120px;">
                              <?php 
                                if($time->time_status != 'Pending'){echo '<span style="display:none">'.date("Ymd", strtotime($time->created)).'</span>'.date('d F Y', strtotime($time->created));}
                                ?>
                            </span>
                        </td>
                                <td><span class="center" style="width:120px;">
                                ...
                                <td><span class="td-text-area" style="width:160px;">
                                    <a href="<?php echo base_url(); ?>timesheet/view_time_list/<?php echo $time->emp_id; ?>/<?php echo $time->week; ?>" class="btn-xs btn-inverse td-btn-marg-right">View</a>
