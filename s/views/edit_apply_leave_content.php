<div class="innerLR" style="margin-top:60px;">
    ...
    <form class="form-horizontal margin-none" id="validateSubmitForm" method="post" autocomplete="off" novalidate="novalidate">    
        <input type="hidden" name="employee_leave_id" value="<?php echo $employee_leave_id;?>" />
		<input type="hidden" name="status" value="<?php echo $employee_leave_detail[0]->status;?>" />
        <div class="widget">
                ...
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <select class="form-control height_25 plahole_font" name="leave_type_id" id="leave_type_id"  onchange="calBalanceLeave(this.value)" style="padding-top: 2px;">
                                    ...
                                    if (!empty($leave_type_detail)) {
                                        foreach ($leave_type_detail as $leave_type) {
                                            ?>
                                            <option value="<?php echo $leave_type->leave_type_id . '|' . $leave_type->leave_type . '|' . $leave_type->weekend_check; ?>"  <?php echo set_select('leave_type_id', $leave_type->leave_type_id . '|' . $leave_type->leave_type . '|' . $leave_type->weekend_check,($employee_leave_detail[0]->leave_type_id==$leave_type->leave_type_id) ? true : false); ?>><?php echo $leave_type->leave_type; ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group date datepicker2 start" onchange="calculateDate()" style="width:100%;">
                                    <input class="form-control height_25" name="from_date" id="from_date" placeholder="From" value="<?php echo date('d F Y',  strtotime($employee_leave_detail[0]->from_date)); ?>" readonly type="text"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group date datepicker2 end" onchange="calculateDate()" style="width:100%;">
                                    <input class="form-control height_25 plahole_font" name="to_date" id="to_date" value="<?php echo date('d F Y',  strtotime($employee_leave_detail[0]->to_date)); ?>" placeholder="To" readonly type="text"/>
                                    <span class="input-group-addon padding_3"><i class="fa fa-th"></i></span>
                                </div>
                                <div id="error_to">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11"> 
                                <input type="text" class="form-control height_25 plahole_font" name="number_of_days" value="<?php echo $employee_leave_detail[0]->number_of_days; ?>" id="number_of_days" placeholder="0" readonly="">
                                ...
                                <select class="form-control height_25 plahole_font" name="manager_id" id="manager_id"  style="padding-top: 2px;">
                                    ...
                                    if (!empty($manager_detail)) {
                                        foreach ($manager_detail as $manager) {
                                            ?>
                                            <option value="<?php echo $manager->id . '|' . $manager->emailId; ?>" <?php echo set_select('manager_id', $manager->id,($employee_leave_detail[0]->manager_id==$manager->id) ? true : false); ?> ><?php echo $manager->empName; ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <textarea rows="4" name="reason" id="reason" class="plahole_font" style="width:100%;resize: vertical;"><?php echo $employee_leave_detail[0]->reason; ?></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" style="margin-top:67px;">
                            ...
                            <div class="col-sm-11">
                                <select class="form-control height_25 plahole_font" name="from_session" id="from_session" onchange="calculateDate()" style="padding-top: 2px;">
                                    <option value="1" <?php echo set_select('from_session', 1,($employee_leave_detail[0]->from_session==1) ? true : false); ?>>First Half</option>
                                    <option value="2" <?php echo set_select('from_session', 2,($employee_leave_detail[0]->from_session==2) ? true : false); ?>>Second Half</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <select class="form-control height_25 plahole_font" name="to_session" id="to_session" onchange="calculateDate()" style="padding-top: 2px;">
                                    <option value="1" <?php echo set_select('to_session', 1,($employee_leave_detail[0]->to_session==1) ? true : false); ?>>First Half</option>
                                    <option value="2" <?php echo set_select('to_session', 2,($employee_leave_detail[0]->to_session==2) ? true : false); ?>>Second Half</option>
                                </select>   
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <input type="text" name="balance_leave" id="balance_leave" value="<?php echo (isset($employee_leave_detail[0]->balance_leave)) ? $employee_leave_detail[0]->balance_leave : 0;; ?>" class="form-control height_25 plahole_font" readonly="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-8 control-label inputtext_formating">CC to:</label>
                            <div class="col-sm-11">
                                <input type="text" name="cc_to" id="cc_to" value="<?php echo $employee_leave_detail[0]->cc_to; ?>"  class="form-control input_width85 height_25 plahole_font" style="width:85%" readonly="readonly">
                                <a href="#modal-login" id="cc" data-toggle="modal" class="btn btn-success pull-right height_25" style="margin-top: -26px;padding-top: 0px;">Select
                                </a>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <textarea rows="4" name="contact_details" id="contact_details" class="plahole_font" style="width:100%;resize: vertical;"><?php echo $employee_leave_detail[0]->contact_details; ?></textarea>
                    ...
                    <div class="col-md-12" id="submit_btn" style="padding-right:6%;">
                        <button type="button"  class="btn btn-success pull-right" style="margin-left: 20px;" onclick="saveForm()">Update</button>
                        <a onclick="window_back();" class="btn btn-danger pull-right">Back</a>
                    </div>
                    <div class="col-md-12" id="submit_btn2" style="padding-right:6%;">
...
<script>
    $(document).ready(function () {
        $('#submit_btn2').hide();
         <?php 
        if (isset($_GET['v'])== 1) { ?>
        $("#validateSubmitForm :input").attr("disabled","disabled");
    ...
    $('#DataTables_Table_0_wrapper .row').find('.col-md-6').eq(1).removeClass('col-md-6').addClass('col-md-12');
        ...
        var total_leave = <?php echo (isset($employee_leave_detail[0]->balance_leave)) ? $employee_leave_detail[0]->balance_leave : 0;; ?>;
        var weekend_check = 0;
